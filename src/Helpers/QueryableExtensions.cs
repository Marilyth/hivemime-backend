...
public static class QueryableExtensions
{
    ...
    public static IQueryable<T> QueryableFind<T>(this IQueryable<T> query, object key) where T : RootEntity
    ...
    public static IQueryable<T> ToQueryable<T>(this T entity, HiveMimeContext context) where T : RootEntity
